  const bodyClass = "bg-purple-800 bg-gradient-to-br from-pink-200 bg-opacity-25";
...
function addClasses(button) {
    const btnNumberClass = "hover:bg-blue-500 border-blue-500";
    const btnClearClass = "hover:bg-red-500 border-red-500";
    const btnOpClass = "hover:bg-green-500 border-green-500";
    ...
    const baseClass = "number flex w-12 h-12 justfy-center items-center m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-white border-2 text-2xl"
